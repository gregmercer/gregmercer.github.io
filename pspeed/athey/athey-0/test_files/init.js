      ...
      value: function render() {
        ...
        return React.createElement(
          ...
          React.createElement(
            'div',
            {className: 'container'},
            React.createElement('div', { dangerouslySetInnerHTML: { __html: this.props.message } }),
            React.createElement(
              'div',
              { className: 'sitewide-alert__close' },
              this.props.dismissible && React.createElement(
                'button',
                { className: 'close', onClick: this.dismissAlert, 'aria-label': 'Close alert message' },
                React.createElement(
                  'span',
                  { 'aria-hidden': 'true' },
                  '\xD7'
